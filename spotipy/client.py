...
class Spotify(object):
    ...
    def auth_manager(self, auth_manager):
        if auth_manager is not None:
            ...
            self._auth_manager = (self.client_credentials_manager or
                                  self.oauth_manager)
    ...
    def user_playlist_unfollow(self, user, playlist_id):
        """ Unfollows (deletes) a playlist for a user
            ...
            Parameters:
                ...
                - name - the name of the playlist
        """
        return self._delete("users/%s/playlists/%s/followers" % (user,
                                                                 playlist_id))

    def user_playlist_add_tracks(self,
                                 user,
                                 playlist_id,
                                 tracks,
                                 position=None):
    ...
    def user_playlist_remove_all_occurrences_of_tracks(self,
                                                       user,
                                                       playlist_id,
                                                       tracks,
                                                       snapshot_id=None):
    ...
    def user_playlist_follow_playlist(self, playlist_owner_id, playlist_id):
        ...
        """
        return self._put("users/{}/playlists/{}/followers".format(
    ...
    def user_playlist_is_following(self, playlist_owner_id, playlist_id,
        ...
        return self._get(
            endpoint.format(playlist_owner_id, playlist_id, ",".join(
                user_ids)))
    ...
    def seek_track(self, position_ms, device_id=None):
        ...
        if not isinstance(position_ms, int):
            ...
            return
        return self._put(
            self._append_device_id("me/player/seek?position_ms=%s" %
    ...
    def repeat(self, state, device_id=None):
        ...
        if state not in ["track", "context", "off"]:
            ...
            return
        self._put(
            self._append_device_id("me/player/repeat?state=%s" % state,
                                   device_id))
    ...
    def shuffle(self, state, device_id=None):
        ...
        self._put(
            self._append_device_id("me/player/shuffle?state=%s" % state,
                                   device_id))
